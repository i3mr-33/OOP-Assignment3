...
#ifndef InverseTicTacToe_H
#define InverseTicTacToe_H
 ...
 * @see Board
 */
class InverseTicTacToe_Board : public Board<char> {
private:
 ...
 * @see UI
 */
class InverseTicTacToe_UI : public UI<char> {
public:
    /**
